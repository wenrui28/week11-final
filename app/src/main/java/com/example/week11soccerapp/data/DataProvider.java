...
public class DataProvider<T extends SoccerEntity> {
    ...
    public DataProvider(Supplier<List<T>> supplier) {
        if (supplier == null) {
    ...
    public static DataProvider<Team> forTeams() {
        return new DataProvider<>(DataProvider::createSampleTeams);
    }

    public static DataProvider<Player> forPlayers() {
        return new DataProvider<>(DataProvider::createSamplePlayers);
    }

    public static DataProvider<Match> forMatches() {
