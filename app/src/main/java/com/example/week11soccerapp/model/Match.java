...
public class Match implements SoccerEntity {
    ...
    public Match(String homeTeam, String awayTeam, String score, String competition, String date, String venue) {
        if (isBlank(homeTeam) || isBlank(awayTeam) || isBlank(score)
                || isBlank(competition) || isBlank(date) || isBlank(venue)) {
        ...
        this.id = (this.homeTeam + "_" + this.awayTeam + "_" + this.date).toLowerCase().replace(" ", "_");
    }
